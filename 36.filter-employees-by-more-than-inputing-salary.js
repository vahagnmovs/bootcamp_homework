...
function checkIfAllSalaryGreaterN(array, n = 0) {
    return array.every(person => Number(person.salary.split('$')[1]) > n)
}

console.log(checkIfAllSalaryGreaterN(employees, 1000))